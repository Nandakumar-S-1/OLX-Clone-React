...
//             <input type="text" placeholder="Find Cars,Mobile Phones, and More..." className="w-full p-3 border-black border-2 border-solid rounded-md placeholder:text-ellipsis focus:outline-none focus:border-teal-300"/>
//             <div style={{backgroundColor:'#002f34'}} className="flex justify-content items-center absolute top-0 right-0 h-full rounded-e-md w-12 ">
//                 <img className="w-5 filter invert" src={searchwt} alt="Search Icon" />
//             </div>
//         </div>
